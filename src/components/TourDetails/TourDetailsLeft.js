...
const TourDetailsLeft = () => {
  ...
  if(tourDetailsLeft[getPageNumber] && tourDetailsLeft[getPageNumber]['overview']!=undefined){

    const { overview, overviewList, overviewListEx, faq, superb, reviewScore, comments, reviews } =
  tourDetailsLeft[getPageNumber];
